...
namespace TescoClpBackend.ClpLogics
{
    public class ContainerPacker
    {
        ...
        private IEnumerable<Container<ClpItem>> LoadMoreThanContainerLots(ref List<LotItem> sortedItems)
        {
        ...
        private Container<ClpItem> FindSuitableContainer(List<Container<ClpItem>> containers, double requiredCbm)
        {
            return containers
        ...
        private void PackByPo( LotItem lotItem, List<Container<ClpItem>> containers)
        {
        ...
        private void AddPoItemsToContainer(IEnumerable<ClpItem> poItems, List<Container<ClpItem>> containers)
        {
        ...
        private void PackBySku(IEnumerable<ClpItem> poItems, List<Container<ClpItem>> containers)
        {
        ...
        private void SplitSku(IEnumerable<ClpItem> skuItems, List<Container<ClpItem>> containers)
        {
        ...
        private void ReduceUnderUtlized(IEnumerable<Container<ClpItem>> underUtilizedContainers)
        {
        ...
        private void AddLotItemToContainer(double minCapacity, double maxCapacity, List<Container<ClpItem>> containers, LotItem lotItem)
        {
            // Try to find an existing container that can fit the entire LotItem
            var suitableContainer = containers.FirstOrDefault(c => c.CanAddItems(lotItem.Items));
        ...
        private void SwapItemsBetweenContainers(Container<ClpItem> containerA, Container<ClpItem> containerB)
        {
